...
KNOWN_UI_STRINGS = sorted(list(set([
    ...
    # DrawerDropzone
    "Backend connection status", "Connect to Neo4j to upload documents",
    ...
    # Settings Page Sidebar & Headers
    "General", "Account & Context", "AI Engine & Sources", "Graph Settings",
    "Secure Vault", "Administration", "Settings", "Workspace Control Center",
    "General Workstation", "Display, language and workspace appearance preferences.",
    "Interface Language", "Select your preferred language for the UI.",
    "Theme", "Toggle between Dark (Luxury) and Light mode.",
    "Switch to Light", "Switch to Dark",
    "Your profile, active patient context, and session management.",
    "Active Patient Context", "Select the patient to personalise the clinical AI context.",
    "Session", "Log out of the application.", "Logout",
    "Configure the LLM model and chatbot retrieval settings.",
    "LLM Model", "Select the language model for knowledge extraction and chat.",
    "Select Model", "Chat Retrieval Mode",
    "Configure which knowledge sources the AI assistant uses during chat.",
    "Configure Sources", "Knowledge graph construction and schema settings.",
    "Store API keys and secrets securely. Used as backend environment overrides.",
    "Secret Name", "Secret Value", "Save Secret", "Configured Secrets", "Load",
