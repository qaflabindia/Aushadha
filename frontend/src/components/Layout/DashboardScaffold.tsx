...
const DashboardScaffold: React.FC<DashboardScaffoldProps> = ({
  ...
  return (
    <div
      className={clsx("flex h-screen w-screen overflow-hidden transition-all duration-700 font-['Inter']", {
    ...
    >
      ...
      <div className='flex-1 flex flex-col relative z-10 transition-all duration-500'>
        ...
        <header
          className={clsx('h-16 z-30 flex items-center glass-luxe transition-all duration-300', {
        ...
        <div className='flex flex-1 overflow-hidden'>
          ...
          <aside
            className={clsx('w-[72px] z-20 flex flex-col items-center glass-luxe transition-all duration-500', {
          ...
          <main
            className={clsx(
              'flex-1 flex flex-col overflow-hidden min-h-0 relative z-10 p-4 transition-all duration-500',
              {
          ...
          >
            <div className='flex-1 flex flex-col min-h-0 glass-luxe border-grad-gs rounded-[20px] overflow-hidden shadow-2xl'>
              {children}
            </div>
          </main>
        </div>
