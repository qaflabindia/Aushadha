    ...
    <div className={clsx("relative", className)} ref={menuRef} style={{ width }}>
      ...
      >
        <div className="flex items-center gap-3 truncate">
          ...
          <span className={clsx("truncate font-medium tracking-wide", {
      ...
      {isOpen && (
        <div
          className={clsx(
            "absolute z-50 w-full mt-2 rounded-xl border overflow-hidden shadow-2xl origin-top animate-inc-scale",
            {
              'bg-[#0f1015]/95 border-white/10 backdrop-blur-2xl': colorMode === 'dark',
              'bg-white/95 border-gray-100 backdrop-blur-xl': colorMode === 'light',
            }
          )}
        >
              ...
              return (
                ...
                >
                  <div className="flex items-center gap-3 overflow-hidden">
                    {opt.icon && (
                      <span className={clsx("flex-shrink-0 opacity-70 transition-opacity group-hover:opacity-100", {
                        'text-[#D4AF37]': colorMode === 'dark',
                        'text-blue-600': colorMode === 'light',
                      })}>
                        {opt.icon}
                    ...
                    <div className="flex flex-col truncate">
                      ...
                      {opt.description && (
                        <span className={clsx("text-xs mt-0.5 truncate", {
                  ...
                  {isSelected && (
                    <RiCheckLine className={clsx("w-5 h-5 flex-shrink-0 ml-3", {
                      'text-[#D4AF37]': colorMode === 'dark',
                      'text-blue-600': colorMode === 'light',
                    })} />
                  )}
